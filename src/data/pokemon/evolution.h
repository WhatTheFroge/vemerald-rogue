const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIDGEY]     = {{EVO_LEVEL, 15, SPECIES_PIDGEOTTO}},
    [SPECIES_PIDGEOTTO]  = {{EVO_LEVEL, 30, SPECIES_PIDGEOT}},
    ...
    [SPECIES_NIDORAN_F]  = {{EVO_LEVEL, 15, SPECIES_NIDORINA}},
    [SPECIES_NIDORINA]   = {{EVO_LEVEL, 30, SPECIES_NIDOQUEEN}},
    [SPECIES_NIDORAN_M]  = {{EVO_LEVEL, 15, SPECIES_NIDORINO}},
    [SPECIES_NIDORINO]   = {{EVO_LEVEL, 30, SPECIES_NIDOKING}},
    ...
    [SPECIES_GOLBAT]     = {{EVO_LEVEL, 36, SPECIES_CROBAT}},
    ...
    [SPECIES_GRIMER]     = {{EVO_LEVEL, 35, SPECIES_MUK}},
    ...
    [SPECIES_MAGIKARP]   = {{EVO_LEVEL, 25, SPECIES_GYARADOS}},
    ...
    [SPECIES_OMANYTE]    = {{EVO_LEVEL, 35, SPECIES_OMASTAR}},
    [SPECIES_KABUTO]     = {{EVO_LEVEL, 35, SPECIES_KABUTOPS}},
    ...
    [SPECIES_CROCONAW]   = {{EVO_LEVEL, 32, SPECIES_FERALIGATR}},
    ...
    [SPECIES_SPINARAK]   = {{EVO_LEVEL, 15, SPECIES_ARIADOS}},
    [SPECIES_CHINCHOU]   = {{EVO_LEVEL, 27, SPECIES_LANTURN}},
    [SPECIES_PICHU]      = {{EVO_LEVEL, 10, SPECIES_PIKACHU}},
    [SPECIES_CLEFFA]     = {{EVO_LEVEL, 21, SPECIES_CLEFAIRY}},
    ...
    [SPECIES_SLUGMA]     = {{EVO_LEVEL, 18, SPECIES_MAGCARGO}},
    [SPECIES_SWINUB]     = {{EVO_LEVEL, 30, SPECIES_PILOSWINE}},
    [SPECIES_REMORAID]   = {{EVO_LEVEL, 25, SPECIES_OCTILLERY}},
    [SPECIES_HOUNDOUR]   = {{EVO_LEVEL, 26, SPECIES_HOUNDOOM}},
    [SPECIES_PHANPY]     = {{EVO_LEVEL, 25, SPECIES_DONPHAN}},
    [SPECIES_TYROGUE]    = {{EVO_LEVEL_ATK_LT_DEF, 22, SPECIES_HITMONCHAN},
                            {EVO_LEVEL_ATK_GT_DEF, 22, SPECIES_HITMONLEE},
                            {EVO_LEVEL_ATK_EQ_DEF, 22, SPECIES_HITMONTOP}},
	...
	// delay Nincada because Shedinja is a bit cheesy. 
    [SPECIES_NINCADA]    = {{EVO_LEVEL_NINJASK, 22, SPECIES_NINJASK},
                            {EVO_LEVEL_SHEDINJA, 22, SPECIES_SHEDINJA}},
    ...
    [SPECIES_SURSKIT]    = {{EVO_LEVEL, 20, SPECIES_MASQUERAIN}},
    [SPECIES_WAILMER]    = {{EVO_LEVEL, 35, SPECIES_WAILORD}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_LEVEL, 35, SPECIES_MILOTIC}},
    ...
    [SPECIES_SNORUNT]    = {{EVO_LEVEL, 35, SPECIES_GLALIE}},	//
    [SPECIES_AZURILL]    = {{EVO_LEVEL, 10, SPECIES_MARILL}},
    [SPECIES_SPOINK]     = {{EVO_LEVEL, 30, SPECIES_GRUMPIG}},
    [SPECIES_MEDITITE]   = {{EVO_LEVEL, 35, SPECIES_MEDICHAM}},
    [SPECIES_SWABLU]     = {{EVO_LEVEL, 35, SPECIES_ALTARIA}},
    [SPECIES_WYNAUT]     = {{EVO_LEVEL, 16, SPECIES_WOBBUFFET}},
    [SPECIES_DUSKULL]    = {{EVO_LEVEL, 30, SPECIES_DUSCLOPS}},	//
    ...
    [SPECIES_WHISMUR]    = {{EVO_LEVEL, 15, SPECIES_LOUDRED}},
    ...
    [SPECIES_ARON]       = {{EVO_LEVEL, 30, SPECIES_LAIRON}},	//
    [SPECIES_LAIRON]     = {{EVO_LEVEL, 40, SPECIES_AGGRON}},	//
    [SPECIES_LILEEP]     = {{EVO_LEVEL, 35, SPECIES_CRADILY}},
    [SPECIES_ANORITH]    = {{EVO_LEVEL, 35, SPECIES_ARMALDO}},
