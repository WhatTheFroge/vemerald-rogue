...
const u8 gText_ExpandedPlaceholder_RemotePlayer[] = _("REMOTE PLAYER");
const u8 gText_ExpandedPlaceholder_PokemonHub[] = _("The Pokémon Hub");
...
const u8 gText_BirchBrendan[] = _("BRENDAN");
const u8 gText_BirchMay[] = _("MAY");
const u8 gText_BirchRed[] = _("RED");
const u8 gText_BirchLeaf[] = _("LEAF");
...
const u8 gText_RunScore[] = _("Run Score");
const u8 gText_RunNumber[] = _("Run No.");
const u8 gText_BirchInTrouble[] = _("Which Pokémon would you like\nto take as your Partner?");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this Partner\nPokémon?");
const u8 gText_CancelStarterChoice[] = _("Do you want to keep your current\nPartner Pokémon instead?");
...
const u8 gMenuText_SortType[] = _("Type");
const u8 gMenuText_SortName[] = _("Name");
const u8 gMenuText_SortValue[] = _("Value");
const u8 gMenuText_SortAmount[] = _("Amount");
...
const u8 gText_SortedByWhat[] = _("Sort Bag by?");
const u8 gText_SortedByName[] = _("Bag sorted by\nName.");
const u8 gText_SortedByType[] = _("Bag sorted by\nType.");
const u8 gText_SortedByValue[] = _("Bag sorted by\nValue.");
const u8 gText_SortedByAmount[] = _("Bag sorted by\nAmount.");
...
const u8 gText_DadsAdvice[] = _("Elm's voice echos…\n{PLAYER}, it's not the place for this…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_StonesPocket[] = _("{FONT_NARROW}Special Items");
const u8 gText_PokeblockPocket[] = _("Poké Block");
...
const u8 gText_CharmsPocket[] = _("CHARMS");
const u8 gText_StonesPocket[] = _("{FONT_NARROW}SPECIAL ITEMS");
const u8 gText_PokeblockPocket[] = _("POKéBLOCK");
const u8 gText_HeldItemsPocket[] = _("HELD ITEMS");
const u8 gText_KeyItemsPocket[] = _("KEY ITEMS");
#endif
...
const u8 gText_Var1FromVar2FromVar3BuildDirection[] = _("Build {COLOR BLUE}{SHADOW LIGHT_BLUE}{STR_VAR_1} {COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}for {SCREW_ICON}{STR_VAR_2}?\nWhich direction {DPAD_NONE} should it be built?");
const u8 gText_Var1AndYouWantedVar2[] = _("{STR_VAR_1}? And you wanted {STR_VAR_2}?\nThat will be ¥{STR_VAR_3}.");
const u8 gText_BuildVar1ToVar2ForVar3[] = _("Build {COLOR BLUE}{SHADOW LIGHT_BLUE}{STR_VAR_1} {COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}to the {STR_VAR_2}.\nFor {SCREW_ICON}{STR_VAR_3}. Is that correct?");
const u8 gText_Var1IsItThatllBeVar2[] = _("{STR_VAR_1}, is it?\nThat'll be ¥{STR_VAR_2}. Do you want it?");
const u8 gText_BuildVar1InThatllBeVar2[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}?\nThat'll take {SCREW_ICON}{STR_VAR_2} to build.");
const u8 gText_BuildVar1InVar2ThatllBeVar3[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}{STR_VAR_1} {COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}in {COLOR BLUE}{SHADOW LIGHT_BLUE}{STR_VAR_2}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}?\nThat'll take {SCREW_ICON}{STR_VAR_3} to build.");
...
const u8 gText_WhatWouldYouLikeToBuild[] = _("What would you like to build?");
const u8 gText_CanIHelpWithAnythingElse[] = _("Can I help you with anything else?");
const u8 gText_ThrowInPremierBall[] = _("I'll throw in a {STR_VAR_1}, too.{PAUSE_UNTIL_PRESS}");
const u8 gText_ThrowInPremierBalls[] = _("I'll throw in {STR_VAR_1}, too.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Release[] = _("Release");
const u8 gText_Rename[] = _("Nickname");
const u8 gText_RelearnMove[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}Learn Moves");
const u8 gText_Evolve[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Evolve");
const u8 gText_CycleSubMenu[] = _("More {DPAD_LEFTRIGHT}");
...
const u8 gText_NoEntry[] = _("Withdraw");
...
const u8 gText_CantBeUsedNot[] = _("This can't be used right now.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CantUseUntilNewBadge[] = _("This can't be used now.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_12PoofForgotMove[] = _("{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.\pAnd…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_DontHave[] = _("Dont't Have");
...
const u8 gText_FullRun[] = _("Full Run");
const u8 gText_SkipAhead[] = _("Skip Ahead");
const u8 gText_SwapOne[] = _("Trade One");
...
const u8 gText_West[] = _("West");
const u8 gText_ExpandSouth[] = _("{DPAD_DOWN} {COLOR GREEN}South");
const u8 gText_ExpandNorth[] = _("{DPAD_UP} {COLOR GREEN}North");
const u8 gText_ExpandEast[] = _("{DPAD_RIGHT} {COLOR GREEN}East");
const u8 gText_ExpandWest[] = _("{DPAD_LEFT} {COLOR GREEN}West");
const u8 gText_CannotExpandSouth[] = _("{DPAD_DOWN} {COLOR RED}South X");
const u8 gText_CannotExpandNorth[] = _("{DPAD_UP} {COLOR RED}North X");
const u8 gText_CannotExpandEast[] = _("{DPAD_RIGHT} {COLOR RED}East X");
const u8 gText_CannotExpandWest[] = _("{DPAD_LEFT} {COLOR RED}West X");
...
const u8 gText_Stones[] = _("Special Items");
...
const u8 gText_TMs_Hms[] = _("TMs & TRs");
const u8 gText_Berries2[] = _("Berries");
//const u8 gText_SomeonesPC[] = _("SOMEONE'S PC");
const u8 gText_SomeonesPC[] = _("Pokémon Storage");
...
const u8 gText_HostAdventure[] = _("Host Group");
const u8 gText_JoinAdventure[] = _("Join Group");
...
const u8 gPCText_PolkaDot[] = _("Polka-do");
...
const u8 gText_PkmnFainted3[] = _("{STR_VAR_1} has survived poisoning…\p\n");
...
const u8 gText_TextNicknameRandom[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Automatic");
...
const u8 gText_MoveRelearnerAndPoof[] = _("{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p");
const u8 gText_MoveRelearnerPkmnForgotMoveAndLearnedNew[] = _("{STR_VAR_1} forgot {STR_VAR_3}\nand learnt {STR_VAR_2}.");
